...
class DataTransformations:
    def __init__(self, batch_size, image_size=(64, 64)):
    ...
    def get_pretrained_model(model_name, num_classes):
        if model_name == 'resnet18':
            ...
            num_ftrs = model.classifier[6].in_features  # Adjust for VGG structure
    ...
    def train_model(model, dataloaders, dataset_sizes, criterion, optimizer, scheduler, num_epochs, device):
        ...
        for epoch in range(num_epochs):
            ...
            for phase in ['train', 'test']:
                ...
                if phase == 'train':
                    scheduler.step()  # Update learning rate (if scheduler used)
                ...
                # Deep copy the model if better on the validation set
